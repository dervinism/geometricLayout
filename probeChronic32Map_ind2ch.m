...
% correspong electrode channel number ID. Designed for a chronic 32-channel probe
...
function [probeMap, probeOutputPins, conf] = probeChronic32Map_ind2ch(probeFlip)
