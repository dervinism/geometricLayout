...
% correspong electrode channel number ID. Designed for the top output pin
% array of an acute 64 channel probe (see
...
function [probeMap, probeOutputPins, conf] = probeAcute64TopMap_ind2ch
