...
% ID gives an output pin location at the top connector. Designed for the
% Adpt-A64-OM32x2-sm adaptor
% (see http://neuronexus.com/support/mapping-and-wiring/adaptor-mapping/
% formerly, https://neuronexus.com/images/Adaptor_Maps/Adpt-A64-OM32x2-sm.pdf).
...
function [adptOMap, adptOPins, conf] = adaptorTopOutMap_ch2ind(adaptorFlip)
